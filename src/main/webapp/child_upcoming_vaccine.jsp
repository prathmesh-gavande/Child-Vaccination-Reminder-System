		...
		<div class="menu-items">
			<ul class="nav-links">
				<li><h2 style="padding: 15px; color: gray;">Welcome
						Newborn</h2></li>
				<li style="background: #EFE8F4;"><a href="ChildUpcomingVaccine"> <i
	...
	<section class="dashboard">
		<div class="top">
			...
			<div style="text-align: center; width: 100%;">
				<h1 style="display: inline-block; margin: 0;">
					<i class="uil uil-calendar-alt"></i> Upcoming Vaccine
				</h1>
			</div>
		...
		<div class="dash-content">
			<section class="view-vaccines-container">
                ...
                <tbody>
                    <% 
                        // Fetch upcoming vaccines from the request
