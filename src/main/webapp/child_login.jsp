	...
	<nav>
		...
		<div class="menu-items">
			<ul class="nav-links">
				...
				<li style="background: #EFE8F4;"><a href="child_login.jsp"> <i class="uil uil-signin"></i>
						<span class="link-name">Child Login</span>
				</a></li>
				<li><a href="hospitalLogin.jsp"> <i class="uil uil-signin"></i>
	...
	<section class="dashboard">
		<div class="top">
			...
			<div style="text-align: center; width: 100%;">
				<h1 style="display: inline-block; margin: 0;">
					<i class="uil uil-signin"></i> Child Login
				</h1>
			</div>
		...
		<div class="dash-content">
            ...
            <section class="dash-content-container">
                <form action="ChildLogin" method="post" class="form">
                    <div class="input-box">
